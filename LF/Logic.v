...
Fact not_implies_our_not : forall (P:Prop),
	~ P -> (forall (Q:Prop), P -> Q).
Proof.
	intros P hp' Q hp. destruct hp'. apply hp.
Qed.
(** [] *)
...
Theorem contrapositive : forall (P Q : Prop),
	(P -> Q) -> (~Q -> ~P).
Proof.
	intros P Q H. unfold not. intros Qcontra HP.
	apply Qcontra in H. destruct H. apply HP.
Qed.
(** [] *)
...
Theorem not_both_true_and_false : forall P : Prop,
	~ (P /\ ~P).
Proof.
	intros P. unfold not. intros [HP Pcontra]. apply Pcontra. apply HP.
Qed.
(** [] *)
...
Proof.
	intros X P Hall [x HPnot]. unfold not in HPnot. apply HPnot. apply Hall.
Qed.
(** [] *)
